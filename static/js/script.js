// Form Listener for adding a patient
...
document.addEventListener('DOMContentLoaded', function() {
    generateChart(); // run chart generation on page load
}, false);

// D3 chart data fetching and creation
function generateChart() {
    d3.select("#chart")
        ...
        .html("Loading chart..."); // clear chart and show it is updating
    ...
    d3.json("/api/patients").then(function(data) {
        ...
        const svg = d3.select("#chart")
            .html("") // clears the loading chart message, but causes it to flicker for a second, don't know of a seamless way to do this
            .append("svg")
